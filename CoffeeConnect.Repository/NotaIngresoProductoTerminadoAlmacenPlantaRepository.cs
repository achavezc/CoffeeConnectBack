...
namespace CoffeeConnect.Repository
{
    public class NotaIngresoProductoTerminadoAlmacenPlantaRepository : INotaIngresoProductoTerminadoAlmacenPlantaRepository
    {
        ...
        public int ActualizarCantidadOrdenProcesoEstado(int notaIngresoProductoTerminadoAlmacenPlantaId, decimal cantidadOrdenProceso, decimal kilosNetosOrdenProceso, DateTime fecha, string usuario, string estadoId)
        {
            int affected = 0;
            ...
            using (IDbConnection db = new SqlConnection(_connectionString.Value.CoffeeConnectDB))
            {
                affected = db.Execute("uspNotaIngresoProductoTerminadoAlmacenPlantaActualizarCantidadOrdenProcesoEstado", parameters, commandType: CommandType.StoredProcedure);
            }
        ...
        public IEnumerable<ResumenNotaIngresoProductoTerminadoAlmacenPlantaBE> ResumenNotaIngresoProductoTerminadoAlmacenPlanta(ResumenNotaIngresoProductoTerminadoAlmacenPlantaRequestDTO request)
        {
            var parameters = new DynamicParameters();
            ...
            using (IDbConnection db = new SqlConnection(_connectionString.Value.CoffeeConnectDB))
            {
                return db.Query<ResumenNotaIngresoProductoTerminadoAlmacenPlantaBE>("uspNotaIngresoProductoTerminadoAlmacenPlantaConsultaResumen", parameters, commandType: CommandType.StoredProcedure);
            }
        }
