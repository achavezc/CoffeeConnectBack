...
{
    public class GenerarPDFNotaSalidaAlmacenPlantaResponseDTO
    {
        public GenerarPDFNotaSalidaAlmacenPlantaResponseDTO()
        {
            Result = new Result();
            Cabecera = new List<CabeceraNotaSalidaAlmacenPlantaPDF>();
            listaDetalleGM = new List<NotaSalidaAlmacenPlantaListaDetallePDF>();
            detalleGM = new List<NotaSalidaAlmacenPlantaDetallePDF>();
        }

        public Result Result { get; set; }
        public IList<CabeceraNotaSalidaAlmacenPlantaPDF> Cabecera { get; set; }
        public IList<NotaSalidaAlmacenPlantaListaDetallePDF> listaDetalleGM { get; set; }
        public IList<NotaSalidaAlmacenPlantaDetallePDF> detalleGM { get; set; }
    }

    public class CabeceraNotaSalidaAlmacenPlantaPDF
    {
    ...
    public class NotaSalidaAlmacenPlantaListaDetallePDF
    {
    ...
    public class NotaSalidaAlmacenPlantaDetallePDF
    {
