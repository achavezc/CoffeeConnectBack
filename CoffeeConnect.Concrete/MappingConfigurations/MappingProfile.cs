...
namespace CoffeeConnect.Service.MappingConfigurations
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<RegistrarActualizarNotaIngresoProductoTerminadoAlmacenPlantaRequestDTO, NotaIngresoProductoTerminadoAlmacenPlanta>();
            ...
            CreateMap<RegistrarActualizarNotaIngresoAlmacenPlantaRequestDTO, NotaIngresoAlmacenPlanta>();
            ...
            CreateMap<RegistrarActualizarDevolucionPrestamoPlantaRequestDTO, DevolucionPrestamoPlanta>();
