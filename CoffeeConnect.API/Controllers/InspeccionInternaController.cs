...
namespace Integracion.Deuda.Controller
{
    ...
    public class InspeccionInternaController : ControllerBase
    {
        ...
        [Route("Registrar")]
        [HttpPost]
        public IActionResult Registrar([FromBody] RegistrarActualizarInspeccionInternaRequestDTO request)
        {
            Guid guid = Guid.NewGuid();
            _log.RegistrarEvento($"{guid.ToString()}{Environment.NewLine}{Newtonsoft.Json.JsonConvert.SerializeObject(request)}");
            ...
            try
            {
                response.Result.Data = _InspeccionInternaService.RegistrarInspeccionInterna(request);
        ...
        [Route("Actualizar")]
        [HttpPost]
        public IActionResult Actualizar([FromBody] RegistrarActualizarInspeccionInternaRequestDTO request)
        {
            Guid guid = Guid.NewGuid();
            _log.RegistrarEvento($"{guid.ToString()}{Environment.NewLine}{Newtonsoft.Json.JsonConvert.SerializeObject(request)}");
            ...
            try
            {
                response.Result.Data = _InspeccionInternaService.ActualizarInspeccionInterna(request);
