...
namespace Integracion.Deuda.Controller
{
    ...
    public class LoteController : ControllerBase
    {
        ...
        public IActionResult ConsultarDetallePorId([FromBody] ConsultaLoteDetallePorLoteIdRequestDTO request)
        {
            ...
            try
            {
                var resultado = _loteService.ConsultarLoteDetallePorLoteId(request);
                response.Result.Data = resultado.listaDetalle;
                response.TotalPesoNeto = resultado.TotalPesoNeto;
                response.PromedioHumedad = resultado.PromedioHumedad;
                response.PromedioRendimiento = resultado.PromedioRendimiento;
